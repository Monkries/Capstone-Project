...
class TeensyLeadscrew {
    ...
    */
    ...
    // @brief Main leadscrew business logic. Reads the encoder, updates the tachometer, calculates any leadscrew movement, then actually queues the steps on the motor.
    void cycle();
